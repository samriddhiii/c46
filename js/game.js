class Game{
        ...
        image(trackimg,0,-height*4,width,height*5)
         ...
         var index = 0;
          ...
          for(var plr in allPlayers)
          {
            ...
            if(frameCount %120===0)
            {
              this.spawnObstacles(allPlayers[plr].y);
            }
    ...
    spawnObstacles(ypos){
      ...
      var randx= Math.round(random(300,1000))
      var randy= Math.round(random(ypos+50,ypos+200))
      
      var obstacle= createSprite(randx,randy,50,50)
